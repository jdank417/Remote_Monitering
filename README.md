...
* **Customizable Thresholds:** Users can set thresholds for CPU, memory, and disk usage to receive alerts.  
...
1. **Operating System:**  
   * macOS (tested on versions from 10.15 Catalina onwards).  
2. **Python:**  
...
4. **Permissions:**  
   * SSH access to the target Linux machines with valid credentials.
   * (For ATHL Squash: DLSadmin vpn tunnel `"vpn.harvard.edu/dlsadmin"`)
...
* **app.py:** Main application script containing all functionalities.  
...
* **Description:** Establishes an SSH connection to the specified host using provided credentials.  
* **Parameters:**  
...
Locate the following line in `app.py`:  
python  
Copy  
...
* **GitHub:** [https://github.com/jdank417/Remote_Monitering](https://github.com/jdank417/Remote_Monitering)
